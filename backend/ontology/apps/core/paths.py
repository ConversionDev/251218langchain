...
def get_project_root() -> Path:
    ...
    Returns:
        모노레포 루트 디렉토리 경로 (RAG/). .env 등은 여기서 읽습니다.
    """
    # ontology: .../RAG/backend/ontology/apps/core/paths.py -> RAG/
    core_dir = Path(__file__).resolve().parent
    app_like = core_dir.parent  # .../apps
    if app_like.name == "apps" and app_like.parent.name == "ontology":
        return app_like.parent.parent.parent
    # 레거시: .../RAG/app/core/paths.py -> RAG/
    if app_like.name == "app":
        return app_like.parent
    return core_dir.parent.parent.parent

...
_SPAM_CLASSIFY_PROMPT = (
    ...
    "0.0(정상)~1.0(확실한 스팸) 사이 숫자 하나로 판정하세요.\n"
    "스팸으로 보는 명확한 신호(있을 때만 높게): 광고·홍보, 피싱·사칭, "
    "금전·계좌·비밀번호 요구, 의심스러운 링크·첨부, 당첨·무료·대출 등 과장 유인, 대량 마케팅.\n"
    "이런 신호가 없으면 낮게 판정: 짧은 개인 인사(예: '안녕', 'ㅎㅇ'), 맥락 있는 업무 메일, "
    "일반 대화는 0.1~0.3. 내용이 짧거나 적다는 이유만으로 확률을 높이지 마세요.\n"
    "다른 설명 없이 '스팸 확률: 0.xx' 형식으로만 출력하세요."
)

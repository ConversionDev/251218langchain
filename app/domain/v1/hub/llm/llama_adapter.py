...
내부적으로 core.llm(LLaMAGate) 및 semantic_classifier_service를 사용합니다.
"""
...
def classify(text: str) -> Literal["BLOCK", "RULE_BASED", "POLICY_BASED"]:
    ...
    """
    try:
        from domain.v1.spokes.chat.services.semantic_classifier_service import (  # type: ignore
...
def is_classifier_available() -> bool:
    ...
    try:
        from domain.v1.spokes.chat.services.semantic_classifier_service import (  # type: ignore
            is_classifier_available as _available,
        )

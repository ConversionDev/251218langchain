...
| 문서 | 설명 |
|------|------|
| [전체-프로젝트-구현현황.md](전체-프로젝트-구현현황.md) | **전체 프로젝트** — 지금까지 구현된 부분만 통합(개요·스택·아키텍처·기능·프론트·실행·성능) |
| [기술서.md](기술서.md) | **기술서** — 프로젝트 기술 사양 요약(개요·스택·아키텍처·기능·데이터·관련 문서 링크) |
| [샘플-PDF-만들기.md](샘플-PDF-만들기.md) | **샘플 PDF** — 이력서/문서 테스트용 샘플 PDF 만드는 방법(HTML 인쇄, 스크립트, 외부 준비) |
